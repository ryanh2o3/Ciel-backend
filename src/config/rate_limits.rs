    ...
    pub fn for_trust_level(level: TrustLevel) -> Self {
        match level {
            ...
            TrustLevel::New => RateLimits {
                ...
                moderation_actions_per_hour: 30,
            },
            TrustLevel::Basic => RateLimits {
                ...
                follows_per_hour: 40,
                follows_per_day: 150,
                unfollows_per_day: 75,
                likes_per_hour: 200,
                comments_per_hour: 60,
                login_attempts_per_hour: 30,
                feed_requests_per_hour: 600,
                notifications_per_hour: 600,
                search_requests_per_hour: 300,
                media_read_per_hour: 2000,
                media_upload_per_hour: 60,
            ...
            TrustLevel::Verified => RateLimits {
                posts_per_hour: 500,
                posts_per_day: 2000,
                follows_per_hour: 2000,
                follows_per_day: 10000,
                unfollows_per_day: 5000,
                likes_per_hour: 10000,
                comments_per_hour: 2000,
                login_attempts_per_hour: 300,
