...
pub struct AppConfig {
    ...
    pub sqs_access_key: String,
    pub sqs_secret_key: String,
...
impl AppConfig {
    pub fn from_env() -> Result<Self> {
        ...
        Ok(Self {
            ...
            sqs_access_key: if is_serverless { String::new() } else { env_or("SQS_ACCESS_KEY", "") },
            sqs_secret_key: if is_serverless { String::new() } else { env_or("SQS_SECRET_KEY", "") },
