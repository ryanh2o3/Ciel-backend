...
VALUES
    ('00000000-0000-0000-0000-000000000001', 'demo', 'demo@example.com', 'Demo User', 'Hello from Luminé.', '$argon2id$v=19$m=19456,t=2,p=1$c29tZXNhbHQ$RdescudvJC1OeqEcglpmXw'),
