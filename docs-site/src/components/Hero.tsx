...
const code = `// Ciel API process (simplified)
#[tokio::main]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                Photo-first social platform: Rust API, media worker, SwiftUI
                iOS, and Jetpack Compose Android—documented in one place.
              </p>
              <div className="mt-8 flex flex-wrap gap-4 md:justify-center lg:justify-start">
                <Button href="/docs/overview/">Read the docs</Button>
                <Button href={sourceRepositoryUrl} variant="secondary">
                  Source on GitHub
                </Button>
              </div>
            </div>
